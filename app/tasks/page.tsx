...
import { deleteTask, updateTask, type TaskStatus } from "@/lib/tasks";
...
export default function TasksPage() {
  ...
  return (
    <AppShell>
      <div className="mb-8">
        <div className="text-xs tracking-[0.2em] uppercase text-muted-foreground">Overview</div>
          ...
          <table className="w-full text-sm border border-border bg-background">
            <thead className="bg-secondary text-secondary-foreground">
              <tr>
                ...
                <th className="text-right p-2 text-xs tracking-[0.18em] uppercase">Actions</th>
              </tr>
            </thead>
            <tbody>
              {tasks.length === 0 ? (
                  ...
                  .map((t) => (
                    <tr key={t.id} className="border-t border-border">
                      ...
                      <td className="p-2 min-w-[240px]">
                        <div className="font-medium">{t.taskTitle || "Untitled"}</div>
                        {t.notes ? (
